# preprocessing_file.py - modified for Wipro data from earlier trial runs
...
dir1 = "../data_sachin/"
testFile = ''.join([dir1,'AZ_train_data_till_aug13_v2.csv'])
stopFile = ''.join([dir1,'stopwords_upd.csv'])
mapFile = ''.join([dir1,'word_mapping_KW_upd.csv'])
outFile1 = ''.join([dir1,'train_data_az_v2.csv'])
...
counter = 1
for label in [1]:
    dataFile = csv.reader(open(testFile, 'rb'))
